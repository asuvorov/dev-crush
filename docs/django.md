...
1. [10 Libraries for Django projects](https://medium.com/@marcnealer/10-libraries-for-django-projects-04d6ea4c0370)

2. [20 Questions Every Django Developer Asks (Answered by a 10-Year Veteran)](https://medium.com/@anas-issath/13ccca2d57cd)

3. [Applying Programming Best Practices in Django](https://medium.com/@syauqi.armanaya/solid-for-the-best-1159d99166b4)

4. [Beginner’s Guide to Writing Unit Tests for Django Apps](https://medium.com/@abdul45.wajid/beginners-guide-to-writing-unit-tests-for-django-apps-81f355670830)

5. [Clean Django Architecture Without Overengineering: What HackSoft Got Right](https://medium.com/@Am_Issath/6af521e7918c)

6. [Django + HTMX = Simple modals](https://medium.com/@marcnealer/django-htmx-simple-modals-d76a4cdbe2c0)

7. [Django Backend Foundations: Extending with Django REST Framework](https://medium.com/@titoadeoye/django-backend-foundations-extending-with-django-rest-framework-b28aad6eef53)

8. [Django Code That Looks Fine But Isn’t](https://medium.com/@anas-issath/95d79cb47edf)

9. [Django REST Framework Serializers Are Slow](https://medium.com/@anas-issath/d29c597f5a94)

10. [Django Signals Sent 47 Welcome Emails to One User (And I Only Called `save()` Once)](https://medium.com/@anas-issath/4575868bbb0f)

11. [Django Static Files Disappeared After Production Deploy](https://medium.com/@anas-issath/c23b3ec3f5df)

12. [Django vs FastAPI vs Flask: The 2025 Framework Decision Matrix](https://medium.com/@anas-issath/6a8d9741e7ee)

13. [Django’s `@atomic` Decorator Didn’t Prevent My Race Condition (And the Docs Never Warned Me)](https://medium.com/@anas-issath/58a98177cb9e)

14. [Getting Started with Django Unfold: A Modern UI for Django Admin](https://medium.com/django-unleashed/getting-started-with-django-unfold-a-modern-ui-for-django-admin-aeb8be63bd0a)

15. [How Django Projects Should Evolve From Prototype to Production](https://medium.com/@anas-issath/d4e9ad338ba9)

16. [How I Made a Django API 40x Faster](https://medium.com/@anas-issath/03ffd3973f47)

17. [How I Made My Django Rest API 3x Faster](https://medium.com/@devang.hingu/how-i-made-my-django-rest-api-3x-faster-0f4733ee567b)

18. [How I Monitor Django Apps in Production (2025 Edition)](https://medium.com/@anas-issath/48151f203029)

19. [How to Write High-Performance Tests in Django Like a Real Backend Engineer](https://medium.com/@Am_Issath/cb73f803c2c8)

20. [How We Monitor and Debug Errors Using Sentry in Our Django Project](https://medium.com/@vinasllgn/monitoring-340ddb473ad9)

21. [I Tested Every Django Query Method. Here’s What Actually Matters](https://medium.com/@anas-issath/37f930c94e45)

22. [JWT-Powered Django APIs: The Authentication Architecture Behind Real-World Products](https://medium.com/@Am_Issath/e64f209f0cc9)
